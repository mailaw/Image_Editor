...
public class PaintBrushToolUI extends JPanel implements ChangeListener {
	...
	public void setBrushColor(double r, double g, double b) {
		red_slider.setValue((int)(r * 100.0));
		green_slider.setValue((int)(g * 100.0));
		blue_slider.setValue((int)(b * 100.0));
	}
	
	public int getBrushSize(){
		return brush_slider.getValue(); //get input from the slider
	}
	
	public double getOpacity() {
		return (double) opacity_slider.getValue() / 100.0;
	}
}
