...
public class ImageEditorController implements ToolChoiceListener, MouseListener, MouseMotionListener {
	...
	private static ImageEditorController IMAGE_EDITOR_CONTROLLER;
	public static ImageEditorController getImageEditorController() {
		return IMAGE_EDITOR_CONTROLLER;
	}
	...
	public ImageEditorController(ImageEditorView view, ImageEditorModel model) {
		this.view = view;
		this.model = model;
		ImageEditorController.IMAGE_EDITOR_CONTROLLER = this;
	...
	public PixelInspectorTool getInspectorTool(){
		return inspector_tool;
	}
