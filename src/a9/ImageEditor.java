...
public class ImageEditor {
	public static void main(String[] args) throws IOException {
		...
		Picture f = PictureImpl.readFromURL("http://data.whicdn.com/images/184432899/large.jpg");
		
//		if (ImageEditorView.urlEntered = true){
//			try{
//			f = PictureImpl.readFromURL(ImageEditorView.getURL());
//			}
//			catch (Exception e){
//				e.printStackTrace();
//			}
